...
async function main() {
  ...
  try {
    ...
    const rutas = [
      ...
      ["GET /api/honorarios/bhe/campos", `/api/honorarios/bhe/campos`],
      ["GET /api/correccion-monetaria", `/api/correccion-monetaria?empresa_id=${empresa.id}&anio=${periodo.slice(0, 4)}`],
      ["GET /api/correccion-monetaria/clasificaciones", `/api/correccion-monetaria/clasificaciones?empresa_id=${empresa.id}&anio=${periodo.slice(0, 4)}`],
      ["GET /api/renta-anual", `/api/renta-anual?empresa_id=${empresa.id}&anio=${periodo.slice(0, 4)}`],
      ["GET /api/renta-anual/f22", `/api/renta-anual/f22?empresa_id=${empresa.id}&anio=${periodo.slice(0, 4)}`],
